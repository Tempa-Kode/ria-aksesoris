...
Route::get('/lupa-password', [\App\Http\Controllers\LupaPasswordController::class, 'index'])->name('lupa-password.form');
Route::post('lupa-password', [\App\Http\Controllers\LupaPasswordController::class, 'kirimLinkReset'])->name('lupa-password');
Route::get('/reset-password/{token}', [\App\Http\Controllers\LupaPasswordController::class, 'resetPasswordForm'])->middleware('guest')->name('password.reset');
