    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-main-body">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
                <h6 class="fw-semibold mb-0">Tambah Data Kategori</h6>
            ...
            <div class="card h-100 p-0 radius-12">
                <div class="card-header border-bottom bg-base py-16 px-24">
                    <h6 class="text-lg fw-semibold mb-0">Form Tambah Kategori</h6>
                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="mb-20">
                                    ...
                                    <input type="text"
                                        ...
                                        name="nama" value="{{ old("nama") }}" placeholder="Masukkan nama kategori">
                                    @error("nama")
