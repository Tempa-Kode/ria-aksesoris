...
<section class="auth forgot-password-page bg-base d-flex flex-wrap" style="background-color: white">
    <div class="auth-left d-lg-block d-none" style="background-color: white">
        <div class="d-flex align-items-center flex-column h-100 justify-content-center" style="background-color: white">
            <img src="{{ asset('dashboard/assets/images/auth/forgot-pass-img.png') }}" alt="">
        </div>
    </div>
    <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
        <div class="max-w-464-px mx-auto w-100">
            ...
            <div>
                ...
                <p class="mb-32 text-secondary-light text-lg">Masukkan alamat email yang terhubung dengan akun Anda, dan kami akan mengirimkan tautan untuk mereset kata sandi Anda.</p>
            </div>
            <form action="{{ route('lupa-password') }}" method="post">
                ...
                <div class="icon-field">
                    ...
                    <input type="email" class="form-control h-56-px bg-neutral-50 radius-12" placeholder="Masukkan email anda" name="email">
                </div>
